...
def game_intro():
    ...
    while intro:
        ...
        TextSurf, TextRect = text_objects("LOGO",largeText)
...
def game_den():
    ...
    while den:
        ...
        gameDisplay.fill(white)
        largeText = pygame.font.Font('freesansbold.ttf',60)
        TextSurf, TextRect = text_objects("GAME DEN",largeText)
        TextRect.center = ((display_width / 2  ),(display_height / 2 - 180))
        gameDisplay.blit(TextSurf, TextRect)
        button("ROLL DIE",420,220,100,50,green,bright_green,rollgame)
...
def shooting_intro():
        ...
        while shooting:
            ...
            gameDisplay.fill(white)
            largeText = pygame.font.Font('freesansbold.ttf',60)
            TextSurf, TextRect = text_objects("shooting intro",largeText)
            TextRect.center = ((display_width / 2  ),(display_height / 2 - 180))
            gameDisplay.blit(TextSurf, TextRect)
            button("START GAME",420,220,100,50,green,bright_green,shootgame)
            button("QUIT",420,300,100,50,red,bright_red,quitgame)
...
def jumpy():
    ...
    img_dir = path.join(path.dirname(__file__), 'img')
    gameDisplay = pg.display.set_mode((WIDTH1, HEIGHT1))
    class Game:
        def __init__(self):
            ...
            pg.init()
            pg.mixer.init()
            self.screen = pg.display.set_mode((WIDTH1,HEIGHT1))
...
def ballgame_intro():
    ...
    while ballintro:
        ...
        TextRect.center = ((display_width / 2  ),(display_height / 2 - 180))
        gameDisplay.blit(TextSurf, TextRect)
        button("GO",420,220,100,50,green,bright_green,ballgame)
        button("Quit",420,300,100,50,red,bright_red,quitgame)
...
def tilegame_intro():
    ...
    while tileintro:
        ...
        button("GO",700,100,100,50,green,bright_green,tilegame)
        button("Quit",700,180,100,50,red,bright_red,quitgame)
